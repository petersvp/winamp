...
Note: This repo contains references to trade secrets and protected code, stupidly leaked by WinAmp github maintainers. It's sad to see such things happening, but they do happen.
Looks like WinAmp contains GPLv2 code too!
